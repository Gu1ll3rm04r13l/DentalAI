    ...
    <section className="py-20 px-4 bg-slate-50/50">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-slate-500">Sin los lunes difíciles ni los feriados</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {beneficios.map((b, i) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">{b.titulo}</h3>
              <p className="text-slate-500 text-sm leading-relaxed">{b.descripcion}</p>
            </motion.div>
          ))}
        </div>
      </div>
