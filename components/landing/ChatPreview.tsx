    ...
    <section className="py-16 px-4">
      <div className="max-w-2xl mx-auto">
        <motion.div
          ...
          className="rounded-3xl border border-slate-200 bg-white shadow-2xl shadow-slate-200/60 overflow-hidden"
        >
          ...
          <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-100 bg-slate-50/80">
            ...
            <div className="flex-1 text-center">
              <span className="text-sm font-medium text-slate-500">Chat con Sarah</span>
            </div>
            <div className="w-12" />
          </div>
          ...
          <div className="px-5 py-4 border-t border-slate-100 bg-slate-50/50">
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white border border-slate-200">
              <span className="text-slate-300 text-sm flex-1">Escribí tu mensaje...</span>
